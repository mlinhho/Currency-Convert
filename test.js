...
test("One dollar should be 137.08 yen", function(){
    ...
    // this is the comparison for the unit test
     expect(fromDollarToYen(3.5)).toBe(479.8); //1 dollar are 127.9 yen, then 3.5 dollars should be = (3.5 * 127.9)
})
...
test("One yen should be 0.0062 pound", function(){
    ...
    // this is the comparison for the unit test
     expect(fromYenToPound(3.5)).toBe(0.0217); //1 dollar are 127.9 yen, then 3.5 dollars should be = (3.5 * 127.9)
})